...
CARGO_TARGET_DIR="${CARGO_TARGET_DIR:-target-codex-p32feedback}"
STORE_DIR="${STORE_DIR:-target/p3-feedback-workload-shift-store-${DATE_TAG}}"
OUT_DIR="${OUT_DIR:-remote-logs}"
OUT_JSON="${OUT_JSON:-${OUT_DIR}/p3-feedback-workload-shift-p32-${DATE_TAG}.json}"
