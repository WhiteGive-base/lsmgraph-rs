\begin{table}[t]
\centering
\caption{System-level comparison of query throughput and latency across SemL0 and related systems.}
\label{tab:e11-system-baseline}
\begin{tabular}{lllccccccc}
\toprule
System & Layout principle & Update model & Query semantics visible to L0 & QPS & P95 us & P99 us & Update throughput & Store GB \\
\midrule
SemL0 (benefit-scored) & Semantic benefit scoring & Append-only L0 & Yes (src\_label, edge\_type, degree) & N/A & N/A & N/A & N/A & N/A \\
