...
const DEFAULT_DATA: &str = "data/social_network";
const DEFAULT_STORE: &str = "store/sf1";
...
enum Command {
    ...
    SnbValidate {
        ...
        #[arg(
            long,
            default_value = "deps/ldbc_snb_interactive_impls/dgs/validation_params.csv"
        )]
    ...
    SnbValidateBatch {
        ...
        #[arg(
            long,
            default_value = "deps/ldbc_snb_interactive_impls/dgs/validation_splits"
        )]
    ...
    SnbValidateMixed {
        ...
        #[arg(
            long,
            default_value = "deps/ldbc_snb_interactive_impls/dgs/validation_params_tugraph.csv"
        )]
        validation_params: PathBuf,
        #[arg(long, default_value_t = 100)]
        max_lines: usize,
